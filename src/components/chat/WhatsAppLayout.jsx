...
const WhatsAppLayout = () => {
    ...
    const fetchGroups = useCallback(async () => {
        ...
        try {
            ...
            // Auto-update selected group details if it's currently open
            if (selectedGroup) {
    ...
    useEffect(() => {
        ...
        socketRef.current.on('updateGroupList', () => {
            fetchGroups(); // Debounce this in production if high traffic
        });
    ...
    const handleBackToList = () => {
        ...
        setIsCreatingGroup(false);
        // Clear history state if we came from settings
